                            ...
                            <c:forEach var="i" items="${list}">
                                <div class="col-sm-4 d-flex ftco-animate">
                                    <div class="blog-entry align-self-stretch contentPage">
                                        <a href="${context}/PetProduct/Detail?id=${i.ESId}" class="block-20 rounded" style="background-image: url('${context}/ImageItems/${i.image}');">
                                        </a>
                                        <div class="text p-4">
                                            <div class="meta mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-9">
                                                    <a href="${context}/Order/Store?FId=${i.ESId}">
                        ...
                        <div style="border-width: 0.1px;
                            ...
                            <ul>
                                <c:forEach var="a" items="${animals}">
                                    <li>${a.name} (${a.accessoriesCollection.size()})</li>
                                    </c:forEach>
                            </ul>
                            <hr/>
